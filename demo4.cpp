...
float cubeVertices[] =
{
    // position (x, y, z)    color (r, g, b)    texture coordinates (s, t)
     0.00f, 0.00f,  0.00f,  1.0f, 1.0f, 1.0f,  0.0f, 0.0f,
    -1.00f, 0.00f,  0.00f,  1.0f, 1.0f, 1.0f,  1.0f, 0.0f,
    -1.00f,  1.00f,  0.00f,  1.0f, 1.0f, 1.0f,  0.0f, 1.0f,
     0.00f,  1.00f,  0.00f,  1.0f, 1.0f, 1.0f,  1.0f, 1.0f,
    -1.00f, 0.00f,  1.00f,  1.0f, 1.0f, 1.0f,  0.0f, 0.0f,
     0.00f, 0.00f,  1.00f,  1.0f, 1.0f, 1.0f,  1.0f, 0.0f,
    -1.00f,  1.00f,  1.00f,  1.0f, 1.0f, 1.0f,  0.0f, 1.0f,
     0.00f,  1.00f,  1.00f,  1.0f, 1.0f, 1.0f,  1.0f, 1.0f,
};
...
void render()
{
    ...
    glBindVertexArray(vao);
    glDrawElements(GL_TRIANGLE_STRIP, sizeof(cubeIndices) / sizeof(GLuint), GL_UNSIGNED_INT, 0);
